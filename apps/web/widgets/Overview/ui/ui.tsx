...
export default function Overview() {
    ...
    return (
        <>
            <div className="bg-[#F0F0F0] w-full h-full overflow-x-hidden p-0 m-0">
                <header className="p-8 bg-white w-full flex flex-row justify-between items-center border-b border-[#F0F0F0]">
                    <h1 className="text-2xl text-[#141522] flex flex-col font-semibold leading-[150%] tracking-[-3%]">
                        <span>{t("overview.hiUser")}</span>
                        <span className="text-[#54577A] text-[16px] mt-2">{t("overview.letsFinish")}</span>
                    </h1>
                ...
                <div className="flex flex-row justify-between">
                    <main className="w-full max-w-172 h-full bg-[#F0F0F0] p-8">
                        <div className="flex flex-row items-center gap-8">
                            <div className="flex flex-col bg-[#141522] max-w-48.5 max-h-53.5 w-full h-full p-5 rounded-[10px]">
                                <span className="text-white text-[16px] font-semibold leading-[150%] tracking-[-2%] mb-4">{t("overview.runningTask")}</span>
                                <span className="text-white text-[32px] font-semibold leading-[150%] tracking-[-2%] mb-4">65</span>
                                <div className="flex flex-row items-center gap-4.5">
                                    <PieChart value={45} size={68} showText={true} />
                                    <div className="flex flex-col">
                                        <span className="text-white text-[20px] font-semibold leading-[150%] tracking-[-2%]">100</span>
                                        <span className="text-[#8E92BC] text-sm font-semibold leading-[150%] tracking-[-2%]">{t("overview.task")}</span>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full max-w-115.5 bg-[#F5F5F7] rounded-[14px] p-5 flex-1 flex flex-col items-center justify-center">
                                <div className="flex flex-row items-center justify-between w-full">
                                    <span className="text-[#141522] text-[16px] font-semibold leading-[150%] tracking-[-2%]">{t("overview.activity")}</span>
                                    <NativeSelect className="text-[#141522]">
                                        <NativeSelectOption value={""} className="text-[#141522] text-[12px] font-medium tracking-[-2%]">{t("overview.thisWeek")}</NativeSelectOption>
                                    </NativeSelect>
                                </div>
                                <div className="bg-white rounded-[10px] mt-5">
                                    <ActivityChart />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8">
                            <div className="flex flex-row items-center justify-between mb-6">
                                <span className="text-[#141522] text-2xl font-bold tracking-[-2%]">{t("overview.monthlyMentors")}</span>
                            ...
                            <div className="flex flex-row gap-8 w-full">
                                {recentVisible.map((mentor) => {
                                    ...
                                    return (
                                        <Card key={`recent-${mentor.id}`} className="w-82 min-w-82 max-w-82 bg-white rounded-[20px] p-6 flex flex-col gap-5 border-none shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
                                            <div className="flex flex-row items-center justify-between w-full">
                                            ...
                                            <CardFooter className="flex flex-row items-center justify-between p-0 pb-6 border-t bg-white border-[#F5F5F7] pt-4">
                                                <div className="flex flex-row items-center gap-2">
                                                    ...
                                                    <span className="text-[#141522] text-sm font-semibold tracking-[-2%]">{mentor.totalTask} {t("common.tasks")}</span>
                                                </div>
                        ...
                        <div className="mt-8">
                            <div className="flex flex-row items-center justify-between mb-6">
                                <span className="text-[#141522] text-2xl font-bold tracking-[-2%]">{t("overview.upcomingTask")}</span>
                                <Pagination className="w-auto m-0">
                                    <PaginationContent className="flex flex-row gap-2">
                                        <PaginationItem>
                                            <Button
                    ...
                    <aside className="p-8 flex flex-col">
                        <DataPicker />
                        {selectedTask && (
                            <div className="mt-8 w-full max-w-93">
                                <div className="flex flex-row items-center justify-between">
                                    <div className="flex flex-col bg-white rounded-[10px] p-6">
                                        <Image className="w-81 h-40 mb-6" src={icDetail1} alt="" loading="lazy" />
                                        <div className="px-6">
                                            <h1 className="text-[16px] text-[#141522] font-semibold tracking-[-3%] leading-[150%] mb-4">
                                                {currentTitle}
                                            </h1>
                                            <div className="flex flex-row items-center gap-5 mb-4">
                                                <span className="text-[#54577A] text-[12px] font-medium tracking-[-2%] leading-[150%]">
                                            ...
                                            <div>
                                                <p className="text-[16px] text-[#141522] font-semibold tracking-[-3%] leading-[150%] mb-4">{t("overview.detailTask")}</p>
